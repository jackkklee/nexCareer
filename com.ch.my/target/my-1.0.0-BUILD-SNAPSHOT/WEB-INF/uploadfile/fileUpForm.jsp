		...
		<table border="1" class="fileUpForm">
			...
			<tr>
				...
				<td><input type="text" name="file_name" required="required"
					autofocus="autofocus" size="45">
			</tr>
			<tr>
				<th>카테고리</th>
				<td><label for="c1">도서</label> <input type="radio"
					name="category" id="c1" value="도서" checked="checked">
					<label for="c2">이미지</label>
					<input type="radio" name="category" id="c2" value="이미지"> 
					<label for="c3">동영상</label><input type="radio" name="category" id="c3"
					value="동영상"> 
					<label for="c4">음악</label> <input type="radio"
					name="category" id="c4" value="음악"> 
					<label for="c5">교육</label><input type="radio" name="category" id="c5" value="교육"> 
					<label for="c6">유틸</label> <input type="radio" name="category" id="c6"
					value="유틸"> 
					<label for="c7">기타</label> <input type="radio" name="category" id="c7" value="기타"></td>
			</tr>
			<tr>
				<th>파일 설명</th>
