...
$('body').append(wmain+", <img src='http://api.openweathermap.org/img/w/"+ icon + ".png'>" + "<br>"+ '현재온도:'+parseInt(temp-273.15)+' '
		+ "<br>"+'최저온도:'+parseInt(temp_min-273.15)+ "<br>"+'최고온도:'+parseInt(temp_max-273.15)+' '
		+ "<br>"+country+' '+city+'<br>');
		 
/* $('body').append(wmain+", <img src='http://api.openweathermap.org/img/w/"+ icon + ".png'>" + '현재온도:'+parseInt(temp-273.15)+' '
		 +'최저온도:'+parseInt(temp_min-273.15)+'최고온도:'+parseInt(temp_max-273.15)+' '
		 +country+' '+city+'<br>'); */		 
