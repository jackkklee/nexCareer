            ...
            <div class="menu-sidebar__content js-scrollbar1">
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li>
                            <a href="chart.html">
                                <i class="far fa-user-circle"></i>Profiles</a>
                        </li>
                        <li>
                            <a href="table.html">
                                <i class="far fa-clipboard"></i>Equipments</a>
                        </li>
                        <li>
                            <a href="form.html">
                                <i class="far fa-check-square"></i>Server</a>
                        </li>
                        <li>
                            <a href="#">
                                <i class="fas fa-calendar-alt"></i>Projects</a>
                        </li>
                    </ul>
                </nav>
            </div>
                                    ...
                                    <div class="noti__item js-item-menu">
                                        ...
                                        <div class="email-dropdown js-dropdown">
                                            ...
                                            <div class="email__item">
                                                <div class="/resources/image img-cir img-40">
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="au-card au-card--no-shadow au-card--no-pad m-b-40">
                                    <div class="au-card-title" style="background-image:url('/resources/images/bg-title-01.jpg');">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="copyright">
                                    <p>COPYRIGHT© BY NEXMORESYSTEMS INC. ALL RIGHTS RESERVED <a href="http://www.nexmore.co.kr/realtest/main.html">NEXMORE</a>.</p>
                                </div>
                            </div>
                        </div>
                    </div>
